...
import com.basicTweetsClassification.WordNetSimilarityCalculation;

public class LoadOrDumpObjectInFile {

	public static HashMap<String, HashMap<String, Double>> wordNetSimilarity = GlobalVariablesForTestTweets.wordNetSimilarity;
	...
	public static void loadSimilaritiesFromFile() {
		String line;
		try {
