 ...
 * 
 * (Note RunTagger.java has a more sophisticated runner. This class is intended
 * to be easiest to use in other applications.)
 */
public class Tagger {
	public Model model;
	...
	public List<TaggedToken> tokenizeAndTag(String text) {
		if (model == null)
			throw new RuntimeException(
					"Must loadModel() first before tagging anything");
	...
	/**
	 * Illustrate how to load and call the POS tagger. This main() is not
	 * intended for serious use; see RunTagger.java for that.
	 **/
	public static void main(String[] args) throws IOException {
		...
		String text = "RT @DjBlack_Pearl: !! @ # .... wat.muhfuckaz running for party?????";
